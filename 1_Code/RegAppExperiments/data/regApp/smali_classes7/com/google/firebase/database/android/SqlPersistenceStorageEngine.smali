...
.method private loadNested(Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 952
    .local v10, "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    new-instance v0, Ljava/util/ArrayList;
    ...
    .line 954
    .local v11, "payloads":Ljava/util/List;, "Ljava/util/List<[B>;"
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v12

    .line 955
    .local v12, "queryStart":J
    ...
    invoke-direct {v1, v9, v0}, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->loadNestedQuery(Lcom/google/firebase/database/core/Path;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 957
    .local v15, "queryDuration":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v17

    .line 959
    .local v17, "loadingStart":J
    :goto_0
    :try_start_0
    ...
    .line 967
    .local v19, "loadingDuration":J
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v21

    .line 969
    .local v21, "serializingStart":J
    ...
    .line 972
    .local v7, "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    const/4 v4, 0x0

    move/from16 v23, v3

    .end local v3    # "sawDescendant":Z
    .local v4, "i":I
    .local v23, "sawDescendant":Z
    :goto_1
    ...
    invoke-direct {v6, v5}, Lcom/google/firebase/database/core/Path;-><init>(Ljava/lang/String;)V

    move-object v5, v6

    .line 981
    .local v5, "savedPath":Lcom/google/firebase/database/core/Path;
    invoke-direct {v1, v5, v10, v4}, Lcom/google/firebase/database/android/SqlPersistenceStorageEngine;->splitNodeRunLength(Lcom/google/firebase/database/core/Path;Ljava/util/List;I)I

    move-result v6

    .line 982
    .local v6, "splitNodeRunLength":I
    ...
    const-string v3, "Loading split node with "
    ...
    .end local v5    # "savedPath":Lcom/google/firebase/database/core/Path;
    ...
    .restart local v5    # "savedPath":Lcom/google/firebase/database/core/Path;
    :cond_1
    move-object/from16 v26, v3
    ...
    invoke-interface {v11, v4, v2}, Ljava/util/List;->subList(II)Ljava/util/List;
    ...
    .line 988
    .end local v6    # "splitNodeRunLength":I
    .end local v26    # "pathString":Ljava/lang/String;
    ...
    .line 992
    .local v3, "savedPath":Lcom/google/firebase/database/core/Path;
    :goto_3
    ...
    .line 996
    :cond_3
    invoke-virtual {v3, v9}, Lcom/google/firebase/database/core/Path;->contains(Lcom/google/firebase/database/core/Path;)Z
    ...
    invoke-static {v6, v5}, Lcom/google/firebase/database/core/utilities/Utilities;->hardAssert(ZLjava/lang/String;)V

    .line 998
    invoke-static {v3, v9}, Lcom/google/firebase/database/core/Path;->getRelative(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/core/Path;

    move-result-object v5

    invoke-interface {v2, v5}, Lcom/google/firebase/database/snapshot/Node;->getChild(Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/snapshot/Node;
    ...
    .line 999
    :cond_4
    invoke-virtual {v9, v3}, Lcom/google/firebase/database/core/Path;->contains(Lcom/google/firebase/database/core/Path;)Z
    ...
    .line 1001
    .end local v23    # "sawDescendant":Z
    .local v5, "sawDescendant":Z
    invoke-static {v9, v3}, Lcom/google/firebase/database/core/Path;->getRelative(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/core/Path;

    move-result-object v6

    .line 1002
    .local v6, "childPath":Lcom/google/firebase/database/core/Path;
    invoke-interface {v0, v6, v2}, Lcom/google/firebase/database/snapshot/Node;->updateChild(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;)Lcom/google/firebase/database/snapshot/Node;

    move-result-object v0

    .line 1003
    .end local v6    # "childPath":Lcom/google/firebase/database/core/Path;
    move/from16 v23, v5

    .line 972
    .end local v2    # "savedNode":Lcom/google/firebase/database/snapshot/Node;
    .end local v3    # "savedPath":Lcom/google/firebase/database/core/Path;
    .end local v5    # "sawDescendant":Z
    .restart local v23    # "sawDescendant":Z
    :goto_4
    ...
    .line 1004
    .restart local v2    # "savedNode":Lcom/google/firebase/database/snapshot/Node;
    .restart local v3    # "savedPath":Lcom/google/firebase/database/core/Path;
    :cond_5
    ...
    .line 1005
    const-string v8, "Loading an unrelated row with path %s for %s"
    ...
    .line 1012
    .local v4, "priorityPath":Lcom/google/firebase/database/core/Path;
    invoke-static {v9, v4}, Lcom/google/firebase/database/core/Path;->getRelative(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/core/Path;)Lcom/google/firebase/database/core/Path;
    ...
    invoke-interface {v0, v5, v6}, Lcom/google/firebase/database/snapshot/Node;->updateChild(Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;)Lcom/google/firebase/database/snapshot/Node;
    ...
    .end local v4    # "priorityPath":Lcom/google/firebase/database/core/Path;
    goto :goto_5
    ...
    .end local v7    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .local v28, "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    ...
    .end local v10    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v29, "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 1018
    invoke-virtual {v9, v1, v2}, Lcom/google/firebase/database/logging/LogWrapper;->debug(Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_6

    .line 1017
    .end local v28    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .end local v29    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v7    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .restart local v10    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_8
    move-object/from16 v28, v7
    ...
    .end local v7    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .end local v10    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v28    # "priorities":Ljava/util/Map;, "Ljava/util/Map<Lcom/google/firebase/database/core/Path;Lcom/google/firebase/database/snapshot/Node;>;"
    .restart local v29    # "pathStrings":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :goto_6
    return-object v0

    .line 964
    .end local v0    # "node":Lcom/google/firebase/database/snapshot/Node;
    .end local v19    # "loadingDuration":J
    .end local v21    # "serializingStart":J
    .end local v23    # "sawDescendant":Z
    .end local v24    # "serializeDuration":J
